...
function contactform() {
    ...
    $('#contact-form').on('submit', function(e) {
        ...
        var $form = $(this);
        var $submitBtn = $form.find('.sendBtn');
        ...
        if (!$form.data('bs.validator').hasErrors()) {
            ...
            $submitBtn.html($submitBtn.text() + '<i class="fas fa-spinner fa-spin"></i>');
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var msg_title = (data.type == "success") ? $('.msg_success').val() : $('.msg_opps').val();
