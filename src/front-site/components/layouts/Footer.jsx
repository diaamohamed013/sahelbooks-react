          ...
          <div className="row">
            ...
            >
              <div className="footerSub_box">
                ...
                <p>{settingsLang[lang].footer_about}</p>
            ...
            >
              <h2 className="footerHead mb-4">{t("front_home.quick_links")}</h2>
              ...
              <ul className="list-unstyled">
                ...
                <li>
                  <NavLink to="/affiliate">{t("front_home.affiliate")}</NavLink>
                </li>
                <li>
                  <NavLink to="/e_invoice">
                    {t("nav.eInvoice")}
                    <span className="home_newFeature">
            ...
            <div className="col-lg-3 col-md-6 col-6 footer-list mb-5">
              ...
              <ul className="list-unstyled">
                {pages.map((page) => (
                  <li key={page.id}>
                    <NavLink to={`/page/${page.slug}`}>{t(page.title)}</NavLink>
                  </li>
                ))}
        ...
        <div className="container">
          <div className="d-flex align-items-center">
            ...
            {settings.enable_multilingual && (
              <div className="selectCategory" ref={langRef}>
                <div
                ...
                >
                  ...
                  <i
                    ...
                    id="IconArrow"
                  />
                  <ul id="lists" className={langOpen ? "open" : ""}>
                    {languages.map((lang) => (
                      <li key={lang.slug} className="categoryOptions">
                        <button
                          type="button"
                          onClick={() => {
                            setLang(lang.slug);
            ...
            <div className="w-100 text-center">
              <span>
                {settingsLang[lang].copyright} © {new Date().getFullYear()}
              </span>
            </div>
          </div>
        </div>
